...
fn main() {
    ...
    if args.is_present("server") {
        ...
        ctrlc::set_handler(move || {
            if run_state_for_handler.request_shutdown() { // Use request_shutdown
        ...
        if let Err(e) = server::serve(args, run_state) { // Pass run_state
        ...
        if let Err(e) = client::execute(args, output.clone(), run_state) { // Pass run_state
